...
/// <summary>
/// PlayMode 测试：验证 SimpleTweenEx 兼容 API 层所有方法的行为。
/// </summary>
public class SimpleTweenExPlayModeTests
{
    ...
    public void Teardown()
    {
        ...
        var mgr = GameObject.Find("SimpleTween~");
        if (mgr != null)
    ...
    {
        SimpleTweenEx.move(m_TestObject, new Vector3(10f, 0f, 0f), 0.2f);
    ...
    public IEnumerator MoveX_ChangesOnlyX()
    {
        ...
        SimpleTweenEx.moveX(m_TestObject, 8f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        m_TestObject.transform.position = new Vector3(1f, 2f, 3f);
        SimpleTweenEx.moveY(m_TestObject, 9f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        m_TestObject.transform.position = new Vector3(1f, 2f, 3f);
        SimpleTweenEx.moveZ(m_TestObject, 7f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        SimpleTweenEx.moveLocal(m_TestObject, new Vector3(5f, -3f, 2f), 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    public IEnumerator MoveLocalX_ChangesOnlyLocalX()
    {
        ...
        SimpleTweenEx.moveLocalX(m_TestObject, 6f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        m_TestObject.transform.localPosition = new Vector3(1f, 2f, 3f);
        SimpleTweenEx.moveLocalY(m_TestObject, -5f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        m_TestObject.transform.localPosition = new Vector3(1f, 2f, 3f);
        SimpleTweenEx.moveLocalZ(m_TestObject, 0f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    public IEnumerator Scale_ChangesLocalScale()
    {
        ...
        SimpleTweenEx.scale(m_TestObject, target, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        SimpleTweenEx.rotateAround(m_TestObject, Vector3.up, 180f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    {
        SimpleTweenEx.rotateAroundLocal(m_TestObject, Vector3.up, 90f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    public IEnumerator Color_ChangesRendererColor()
    {
        ...
        SimpleTweenEx.color(m_TestObject, Color.red, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    public IEnumerator Alpha_ChangesRendererAlpha()
    {
        ...
        SimpleTweenEx.alpha(m_TestObject, 0.25f, 0.2f);
        yield return new WaitForSeconds(0.3f);
    ...
    public IEnumerator AlphaCanvas_ChangesCanvasGroupAlpha()
    {
        ...
        cg.alpha = 1f;
        SimpleTweenEx.alphaCanvas(cg, 0.5f, 0.2f);
        yield return new WaitForSeconds(0.3f);
        Assert.AreEqual(0.5f, cg.alpha, 0.05f);
    }

    // ==============================================================
    // delayedCall（SimpleTween 原生就有，直接调用）
    // ==============================================================
    ...
    {
        bool called = false;
        SimpleTween.delayedCall(m_TestObject, 0.3f, () => called = true);
    ...
    {
        bool called = false;
        SimpleTween.delayedCall(0.3f, () => called = true);
        yield return new WaitForSeconds(0.2f);
        Assert.IsFalse(called);
        yield return new WaitForSeconds(0.2f);
        Assert.IsTrue(called);
    ...
    {
        float x = 0f;
        var item = SimpleTweenEx.move(m_TestObject, new Vector3(7f, 0f, 0f), 0.1f);
        item.SetDelay(0.3f);
        item.SetEase(SimpleTweenType.easeOutQuad);
    ...
    {
        int callCount = 0;
        var item = SimpleTweenEx.scale(m_TestObject, new Vector3(2f, 1f, 1f), 0.1f);
        item.SetLoop(3);
    ...
    {
        var move1 = SimpleTweenEx.move(m_TestObject, new Vector3(3f, 0f, 0f), 0.2f);
        var move2 = SimpleTweenEx.move(m_TestObject, new Vector3(0f, 3f, 0f), 0.2f);
    ...
    public IEnumerator MultipleExTweens_RunWithoutConflict()
    {
        ...
        SimpleTweenEx.move(go1, new Vector3(5f, 0f, 0f), 0.2f);
        SimpleTweenEx.scale(go2, Vector3.one * 2f, 0.4f);
    ...
    {
        var item = SimpleTweenEx.move(m_TestObject, new Vector3(10f, 0f, 0f), 1.0f);
