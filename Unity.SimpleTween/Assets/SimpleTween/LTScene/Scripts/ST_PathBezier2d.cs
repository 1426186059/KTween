...
public class ST_PathBezier2d : MonoBehaviour {
	...
	void Start () {
		...
		SimpleTweenEx.move(dude1, path, 10f).setOrientToPath2d(true);

		// move local
		SimpleTweenEx.moveLocal(dude2, path, 10f).setOrientToPath2d(true);
	}
