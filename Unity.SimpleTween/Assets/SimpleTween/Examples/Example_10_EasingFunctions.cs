...
/// <summary>
/// 示例脚本 10 - 自定义缓动函数
/// 演示：在 SimpleTweenFunc 提供的 Linear 基础上，自定义缓动曲线
/// 并展示多种缓动效果对比
/// </summary>
public class Example_10_EasingFunctions : MonoBehaviour
{
    ...
    public void Play()
    {
        ...
        var tween = SimpleTween.AddTween(gameObject, duration, (t) =>
        {
            float eased = ApplyEasing(t);
            float x = SimpleTweenFunc.easeLinear(0f, moveDistance, eased);
