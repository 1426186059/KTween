...
namespace KTweenAPI
{
    ...
    void KTweenByLinkedList::Update(float DeltaTime)
    {
    ...
    TDoubleLinkedList<TSharedPtr<KTweenItem>>::TDoubleLinkedListNode* KTweenByLinkedList::DoRemove(
    ...
    void KTweenByLinkedList::SetMaxTweenCount(int nCount)
    {
        mItemPool.SetMaxCapacity(nCount);
    }

    TSharedPtr<KTweenItem> KTweenByLinkedList::AddTween(
        UObject* obj,
        float time,
        ...
        ActionDelegate finishFunc)
    {
        ...
        TSharedPtr<KTweenItem> mItem = mItemPool.Pop();
        mItem->bindObj = obj;
        mItem->toggle = true;
        mItem->time = 0;
        mItem->sumTime = time;
    ...
    void KTweenByLinkedList::Cancel(UObject* obj)
    {
        auto mNode = this->mTweenT.GetHead();
        while (mNode != nullptr)
        {
    ...
    void KTweenByLinkedList::CancelAll()
    {
        auto mNode = this->mTweenT.GetHead();
        while (mNode != nullptr)
        {
