...
public static class KTweenFunc
{
    ...
    public static float ApplyEase(KTweenType type, float fPercent)
    {
        ...
        return type switch
        {
            ...
            KTweenType.inQuad      => QuadIn(fPercent),
            KTweenType.outQuad     => QuadOut(fPercent),
            KTweenType.inOutQuad   => QuadInOut(fPercent),
            KTweenType.inCubic     => CubicIn(fPercent),
            KTweenType.outCubic    => CubicOut(fPercent),
            KTweenType.inOutCubic  => CubicInOut(fPercent),
            KTweenType.inQuart     => QuartIn(fPercent),
            KTweenType.outQuart    => QuartOut(fPercent),
            KTweenType.inOutQuart  => QuartInOut(fPercent),
            KTweenType.inQuint     => QuintIn(fPercent),
            KTweenType.outQuint    => QuintOut(fPercent),
            KTweenType.inOutQuint  => QuintInOut(fPercent),
            KTweenType.inSine      => SineIn(fPercent),
            KTweenType.outSine     => SineOut(fPercent),
            KTweenType.inOutSine   => SineInOut(fPercent),
            KTweenType.inExpo      => ExpoIn(fPercent),
            KTweenType.outExpo     => ExpoOut(fPercent),
            KTweenType.inOutExpo   => ExpoInOut(fPercent),
            KTweenType.inCirc      => CircIn(fPercent),
            KTweenType.outCirc     => CircOut(fPercent),
            KTweenType.inOutCirc   => CircInOut(fPercent),
            KTweenType.inBounce    => 1f - BounceOut(1f - fPercent),
            KTweenType.outBounce   => BounceOut(fPercent),
            KTweenType.inOutBounce => fPercent < 0.5f ? (1f - BounceOut(1f - 2f*fPercent))/2f : (1f + BounceOut(2f*fPercent - 1f))/2f,
            KTweenType.inBack      => BackIn(fPercent),
            KTweenType.outBack     => BackOut(fPercent),
            KTweenType.inOutBack   => BackInOut(fPercent),
            KTweenType.inElastic   => ElasticIn(fPercent),
            KTweenType.outElastic  => ElasticOut(fPercent),
            KTweenType.inOutElastic=> ElasticInOut(fPercent),
            KTweenType.spring      => Spring(fPercent),
            KTweenType.shake       => Shake(fPercent),
