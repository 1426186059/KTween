...
/// <summary>
/// 一键生成所有 KTween 示例场景（含可视化物体）
/// 使用: 菜单 → KTween → Create Example Scenes
/// </summary>
public static class CreateExampleScenes
{
    private const string ScenesDir = "Assets/KTween/Scenes";

    [MenuItem("KTween/Create All Example Scenes", false, 10)]
    ...
    [MenuItem("KTween/Create Example Scene...", false, 11)]
...
public class ExampleSceneCreatorWindow : EditorWindow
{
    ...
    private static readonly ExampleEntry[] s_Examples = new[]
    {
        ...
        // ---- KTweenEx 示例 ----
        new ExampleEntry { Name = "Ex-扩展 API 演示", FileName = "ExDemos", ComponentType = typeof(Example_ExDemos), Description = "KTweenEx 扩展方法：move/scale/rotate/color/alpha/chain" },
    };
    ...
    private void OnGUI()
    {
        ...
        EditorGUILayout.Space(10);
        EditorGUILayout.HelpBox("场景将保存到 Assets/KTween/Scenes/", MessageType.Info);
    }
