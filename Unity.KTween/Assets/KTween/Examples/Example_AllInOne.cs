...
public class Example_AllInOne : MonoBehaviour
{
    ...
    public void Demo_DelayedCall()
    {
        ...
        KTween.delayedCall(gameObject, 1.0f, () =>
        {
            Debug.Log($"1秒后: {Time.time:F2}");
        });

        KTween.delayedCall(gameObject, 2.0f, () =>
        {
    ...
    {
        var item = KTween.AddTween(gameObject, 3.0f, null, null);
    ...
    public void Demo_BindGameObject()
    {
        ...
        KTween.AddTween(tempGo, 10.0f, (t) =>
        {
    ...
    public void Demo_CustomEasing()
    {
        ...
        KTween.AddTween(gameObject, 1.5f, (t) =>
        {
            // 弹性缓动曲线
    ...
    public void Demo_Bouncing()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            var up = KTween.AddTween(gameObject, 0.3f, (t) =>
            {
                transform.position = Vector3.Lerp(basePos, peak, t);
            });

            var down = KTween.AddTween(gameObject, 0.4f, (t) =>
            {
